...
// Course 07 Alghorithms Level3.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int SumeachRowOfMarix(vector<vector<int>>& vMatrix)
{
